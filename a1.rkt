...
(define (makefun val name vars) (makevar (lambda (speaker x) (evaluate-line speaker  val (makevar (evaluate-line speaker x vars) "Hamlet" vars))) name vars x))
